...
import type { AgentPermissionMode, ApprovalGrant, ExecutionDialect } from '@terminal-agent/domain';
...
import type { LocalFileChangePreview } from './local-file-service.js';
import { AuthorizationPolicy, type AuthorizationDecision } from './authorization-policy.js';
import { LocalFilePolicy, type LocalFileOperation } from './local-file-policy.js';
